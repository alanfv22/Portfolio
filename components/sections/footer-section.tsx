        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              aria-label="Email"
              className="text-gray-700 hover:text-purple-400 transition-colors duration-200"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="text-gray-700 hover:text-green-400 transition-colors duration-200"
            >
